$(function() {
  var $gridContainer = $('.gridder');
  var $grid = $gridContainer.length
  ...
  if ($gridContainer.length) {
    window.portfolioIsotope = $grid;
    window.portfolioIsotopeContainer = $gridContainer;
  }
  ...
  $.fn.toggleSelected = function(options) {
    return this.each(function() {
      ...
      $container
        .off('click.toggleSelected')
        .on('click.toggleSelected', settings.itemSelector, function() {
          var $item = $(this);
          $item.addClass(settings.classes);
          $item.siblings().removeClass(settings.classes);
        });
    });
  };
...
$(document).ready(function() {
  ...
  $('body').data('bodyClassList', $('body').attr('class') || '');
